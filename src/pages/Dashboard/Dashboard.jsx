    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-page-body">
        ...
        <div className="dashboard-page-content">
          <h1 className="dashboard-page-content-welcome-back">Welcome back, asdasd</h1>
            ...
            <div className="dashboard-page-status-card">
              ...
              <div className="dashboard-page-status-card-body">
                <div className="dashboard-page-status-card-body-item">
                  ...
                  <h4 className="completed-task-status-title task-status-title">Completed</h4>
                </div>
                <div className="dashboard-page-status-card-body-item">
                  ...
                  <h4 className="in-progress-task-status-title task-status-title">In Progress</h4>
                </div>
                <div className="dashboard-page-status-card-body-item">
                  ...
                  <h4 className="not-started-task-status-title task-status-title">Not Started</h4>
                </div>
              </div>
            </div>
