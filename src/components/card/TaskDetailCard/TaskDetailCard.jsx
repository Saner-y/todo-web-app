  ...
  return (
    <div className="task-detail-card-header">
      ...
      <div className="task-detail-card-header-right">
        ...
        <p
          className="task-detail-card-detail-title"
        >
          Priority: <span className="extreme">{taskData.priority}</span>
        </p>
        <p
          className="task-detail-card-detail-title"
        >
          Status: <span className={taskData.status.toLowerCase().replace(" ", "-")}>{taskData.status}</span>
        </p>
...
export default function TaskDetailCard({ task, onTaskUpdate }) {
  ...
  const assignedOn = taskData
    ? taskData.assignedOn instanceof Date
    ...
    <>
      <div className="task-detail-card">
        ...
        <TaskDetailCardFooter
          onTaskUpdate={() => setIsEditDialogOpen(!isEditDialogOpen)}
